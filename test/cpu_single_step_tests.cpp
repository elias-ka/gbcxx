...
testing::AssertionResult AssertCpuStateEquality(
    ...
    const CpuRegistersState& expected,
...
std::vector<std::filesystem::path> GetAllTestFiles()
{
...
const std::vector<std::filesystem::path> kEightBitLoadInstructions = {
...
const std::vector<std::filesystem::path> kSixteenBitLoadInstructions = {
    "01.json", "11.json", "21.json", "31.json", "08.json", "f9.json", "c5.json", "d5.json",
    "e5.json", "f5.json", "c1.json", "d1.json", "e1.json", "f1.json", "f8.json",
};

const std::vector<std::filesystem::path> kEightBitArithmeticAndLogicalInstructions = {
...
const std::vector<std::filesystem::path> kSixteenBitArithmeticInstructions = {
    "09.json", "19.json", "29.json", "39.json", "e8.json", "03.json", "13.json",
    "23.json", "33.json", "0b.json", "1b.json", "2b.json", "3b.json",
};

const std::vector<std::filesystem::path> kControlFlowInstructions = {
...
const std::vector<std::filesystem::path> kRotateInstructions = {
...
const std::vector<std::filesystem::path> kShiftInstructions = {
...
const std::vector<std::filesystem::path> kSwapInstructions = {
    "cb 37.json", "cb 30.json", "cb 31.json", "cb 32.json",
    "cb 33.json", "cb 34.json", "cb 35.json", "cb 36.json",
};

const std::vector<std::filesystem::path> kBitInstructions = {
